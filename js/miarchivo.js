...
const saveToLocalStorage = () =>{
    localStorage.setItem("task_input",txt.textContent)
}
task_submit.addEventListener("click", saveToLocalStorage);
/* button.addEventListener("click", saveToLocalStorage)
task_input.addEventListener("click", saveToLocalStorage) */
...
function work(){
  swal({
      ...
      text: "Su tarea ha sido cargada con éxito",
      icon: "success",
    });
}
...
/* Ejemplo de carrito paara aplicar el save */

const carrito = JSON.parse(localStorage.getItem("carrito"))  || []

const task = ( {id,nombre}) => {
